...
export default function LeftSidebar({ app, isPro = false, isOpen, onClose }) {
  ...
  return (
    <>
      ...
      <div
        className={`w-80 bg-white shadow-lg fixed left-0 top-0 h-screen flex flex-col border-r border-gray-200 z-30 transition-transform duration-300 ease-out
      ...
      >
        ...
        <div className="flex-shrink-0">
          ...
          <div className="p-6 border-b border-gray-200">
            ...
            <p className="text-sm text-gray-500 mt-1">{app.valueProposition}</p>
          </div>
        </div>
